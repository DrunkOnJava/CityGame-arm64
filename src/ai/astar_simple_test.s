...
_astar_test_simple:
    ...
    bl      astar_calculate_manhattan_distance
...
// Returns: x0 = manhattan_distance
//==============================================================================
astar_calculate_manhattan_distance:
...
// Returns: None
.global astar_set_node_costs
astar_set_node_costs:
...
.global astar_benchmark_heuristic
astar_benchmark_heuristic:
    stp     x29, x30, [sp, #-32]!
    mov     x29, sp
    stp     x19, x20, [sp, #16]
...
.global astar_validate_coordinates
astar_validate_coordinates:
